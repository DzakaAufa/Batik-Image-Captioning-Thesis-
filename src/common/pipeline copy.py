...
# ============================================================
# 1. SETUP & CONFIG (Updated Prompts with Numbered Instructions)
# ============================================================

# HIGH CONFIDENCE (> 80%) -> Kita paksa model menyebutkan kelas karena classifier sangat yakin.
PROMPT_HIGH_CONF = (
...
# MID CONFIDENCE (50% - 80%) -> Menggunakan gaya prompt training-mu agar Qwen bekerja secara natural (visual-first).
PROMPT_MID_CONF = (
    "Your task is to generate a precise, objective, and highly accurate visual description of the provided batik image.\n"
...
# LOW CONFIDENCE (< 50%) -> Sangat aman untuk Chat Engine. Model dibebaskan murni deskripsi visual tanpa beban harus memunculkan nama kelas.
PROMPT_LOW_CONF = (
    "Your task is to generate a precise, objective, and highly accurate visual description of the provided batik image.\n"
    "Note that this fabric merely shares minor visual similarities with the '{kelas}' motif.\n"
    "Instructions:\n"
    "1. Start the first sentence by stating the background color and 2 to 4 dominant motif colors, noting its minor visual similarity to the '{kelas}' style.\n"
    "   Example: 'The batik fabric features a black background adorned with red and yellow motifs, sharing minor visual similarities with the {kelas} style.'\n"
    "2. In the second sentence, describe the exact shapes of the main motifs (e.g. geometric lines, natural shapes, abstract curves).\n"
    "3. In the third sentence, describe the pattern arrangement and layout (e.g. diagonal, scattered, repeating grids, symmetrical).\n"
    "4. If isen-isen (small dots or lines) fill the empty spaces, describe them clearly.\n"
    "5. Describe only what is directly visible in the image. Do NOT invent colors not clearly present. Do NOT invent philosophical meanings or historical context.\n"
    "6. Output strictly ONE coherent paragraph of 3 to 4 sentences, without any introductory or concluding remarks."
)
...
class BatikMultimodalPipeline:
    ...
    def process(self, image_path):
        ...
        # STEP 2: Deskripsi Detail Visual via Qwen2.5-VL 
