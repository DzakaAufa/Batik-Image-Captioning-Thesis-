...
class BatikDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # [PERBAIKAN] Prompt bilingual agar model memahami konteks dua bahasa
        prompt = (
            "Jawab dalam Bahasa Indonesia. "
            "Deskripsikan batik ini secara komprehensif, meliputi nama motif, "
            "elemen visual, warna, teknik pembuatan, dan makna filosofisnya: "
        )
        ...
        inputs = self.processor(
            ...
            padding="max_length",
            truncation=True,
            max_length=256,  # [PERBAIKAN] prompt pendek, tidak perlu 256
        )
...
if __name__ == "__main__":
    model, processor = train_blip2_model(
        ...
        output_dir="/mnt/extended-home/dzakaaufa/models/opt-2.7b-indo",
        epochs=20,
        batch_size=1,
        lr=5e-5,
        model_size="opt-2.7b",
