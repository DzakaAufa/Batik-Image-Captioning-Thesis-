...
# ==========================================
# PROMPT DEFINITIONS (Pure Philosophy Focus)
# ==========================================

PROMPT_PHILOSOPHY_EN = (
...
class BatikPhilosophyDataset(Dataset):
    def __init__(self, captions_df, image_dir, processor, is_train=True):
    ...
    def __getitem__(self, idx):
        ...
        # Target output dan prompt di-set murni untuk filosofi
        prompt = PROMPT_PHILOSOPHY_EN.format(kelas=batik_class)
        target_output = philosophy_en
...
def train_qwen_philosophy_model(
    image_dir,
    caption_dir,
    output_dir,
    epochs=10,
    ...
    print(f"Using device: {device} | Target Focus: PURE_PHILOSOPHY")
    ...
    # Load dataset menggunakan class khusus filosofi
    train_dataset = BatikPhilosophyDataset(train_df, image_dir, processor, is_train=True)
    val_dataset = BatikPhilosophyDataset(val_df, image_dir, processor, is_train=False)
    test_dataset = BatikPhilosophyDataset(test_df, image_dir, processor, is_train=False)
    ...
    print("\nTraining Selesai. Memulai Evaluasi Final pada Test Set (Philosophy Only)...")
...
if __name__ == "__main__":
    train_qwen_philosophy_model(
        ...
        output_dir="/mnt/extended-home/dzakaaufa/experiment/models/qwen2_5-VL-pure-philosophy",
        epochs=10,
        batch_size=8,
        lr=1e-4, 
        model_size="Qwen/Qwen2.5-VL-7B-Instruct",
